...
module.exports = function(webpackEnv) {
    ...
    function setEntryConfig(arrayString) {
        ...
        arrayString.map(function (item) {
            entry[item] = [
                ...
                //合成入口文件
                path.resolve(paths.appRoot, item + "/index.js")
            ]
        })
        return entry
    }
    ...
    return {
        ...
        entry: setEntryConfig(paths.appArr),
        output: {
            // The build folder.
            ...
            filename: 'statics/js/[name].bundle.[hash].js',
            // There are also additional JS chunk files if you use code splitting.
            chunkFilename: 'statics/js/[name].chunk.[hash].js',
        ...
        plugins: [
            ...
            ...(setHtmlPluginConfig(paths.appArr)),
